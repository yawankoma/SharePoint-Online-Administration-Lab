...
**6. PowerShell — site verification report**

```powershell
Connect-SPOService -Url https://sko12-admin.sharepoint.com

Get-SPOSite | Select-Object Title, Url, StorageUsageCurrent | Export-Csv -Path "$env:USERPROFILE\Desktop\SKO-Sites-Report.csv" -NoTypeInformation
```
...
**8. PowerShell — permissions verification**

```powershell
Get-SPOSite -Identity "https://sko12.sharepoint.com/sites/IT-Department" | Select-Object Title, SharingCapability, StorageUsageCurrent
```
...
**6. Created Staff Directory page**
- Site → New → Page → Blank
- Added People web part populated with tenant users
- Published page and added to site navigation as `Staff Directory`

**7. Disabled external sharing**
- Active sites → SKO Staff Community → Policies → Sharing → Only people in your organisation

**8. PowerShell — full environment summary report**

```powershell
Get-SPOSite | Where-Object {$_.Url -like "*/sites/*"} | Select-Object Title, Url, SharingCapability, StorageUsageCurrent | Format-Table -AutoSize
```
...
## Summary — Full Environment PowerShell Report

After completing all three layers, the following command was run to confirm the full environment:
...
```
Title                        Url                                              SharingCapability     StorageUsageCurrent
-----                        ---                                              -----------------     -------------------
SKO Corporation Intranet     https://sko12.sharepoint.com/sites/intranet      ExistingExternalUserSharingOnly   1
IT Department                https://sko12.sharepoint.com/sites/IT-Department ExistingExternalUserSharingOnly   1
SKO Staff Community          https://sko12.sharepoint.com/sites/SKO-Community ExistingExternalUserSharingOnly   1
```
